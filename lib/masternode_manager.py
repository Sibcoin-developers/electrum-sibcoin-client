...
from electrum_sib.util import AlreadyHaveAddress, print_error
from electrum_sib.util import format_satoshis_plain
...
class MasternodeManager(object):
    ...
    def check_can_sign_masternode(self, alias):
        ...
        if mn.vin.get('value', 0) != bitcoin.COIN * 1000:
            raise Exception('Masternode requires a collateral 1000 SIB output.')
