...
from electrum_sib.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds
from electrum_sib import bitcoin
from electrum_sib.util import timestamp_to_datetime
...
class SendScreen(CScreen):
    ...
    def do_save(self):
        ...
        from electrum_sib.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_sib.util import create_URI
