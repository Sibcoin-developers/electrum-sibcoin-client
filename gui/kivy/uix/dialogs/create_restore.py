...
from electrum_sib_gui.kivy.uix.dialogs import EventsDialog
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, **kwargs):
        ...
        from electrum_sib.mnemonic import Mnemonic
        from electrum_sib.old_mnemonic import words as old_wordlist
